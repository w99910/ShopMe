<div class="flex flex-col h-full px-5 py-10" x-data="{isOpen:false}" x-data>
    ...
    <div class="flex justify-between items-center">
        <button wire:click="$emit('createpost')" class="px-3 py-2 bg-green-500 rounded-custom text-white focus:outline-none">Create Product</button>
    ...
    @foreach($products as $product)
        <tr>
            ...
            <td class="border px-4 py-2 flex  h-full justify-center text-white">
             <div class="flex items-center flex-col h-full">
               ...
               <p>Are You Sure?</p>
                   <div class="flex justify-center items-center">
                       ...
                       <button wire:click="unconfirm({{$product->id}})" class="border bg-orange-400 px-3 py-1 rounded-lg  focus:outline-none">No</button>
                   </div>
                       @else
