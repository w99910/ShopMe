...
@auth
    <div class="flex">
        <div class="absolute top-0 right-0 mr-3 mt-3 p-2 bg-redme rounded-full block sm:hidden z-100" id="nav">
            <img class="w-5 h-5" src="{{url('images/menu.png')}}" alt="menu">
        </div>
        <header id="header" class="absolute top-0 z-50 sm:z-0 w-full sm:relative flex bg-redme sm:bg-transparent flex-col justify-between items-center sm:mt-1 mb-1 sm:ml-1 text-white sm:w-2/12">
