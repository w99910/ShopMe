...
{{--                        <li class="flex items-center justify-start py-5 cursor-pointer"><img src="{{asset('images/shopping-bag.png')}}" alt="image" class="w-2/12 h-auto mr-3"/>Your choice </li>--}}
                        <li class="flex items-center justify-start py-5 cursor-pointer" x-on:click="window.livewire.emit('discount')"><img src="{{asset('images/sale.png')}}" alt="image" class="w-2/12 h-auto mr-3"/>Discount </li>
                    </ul>
                </nav>
            </div>
